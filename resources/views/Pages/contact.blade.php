...
@section('content')
                    ...
                    <form>
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                            ...
                            <img class="how-pos4 pointer-none"
                                src="{{ URL::asset('/template/images/icons/icon-email.png') }}" alt="ICON">
                        </div>
                    ...
                    <div class="flex-w w-full p-b-42">
                        ...
                        <div class="size-212 p-t-2">
                            ...
                            <p class="stext-115 cl6 size-213 p-t-18">
                                Coza Store Center, 8th floor, New Link Road, Beside Goregaon Sports Complex, Malad West,
    ...
    <div class="map">
        <div class="size-303" id="google_map" data-map-x="40.691446" data-map-y="-73.886787"
            data-pin="{{ URL::asset('/template/images/icons/pin.png') }}" data-scrollwhell="0" data-draggable="1"
            data-zoom="11"></div>
    </div>
@endsection
